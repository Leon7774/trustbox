      ...
      {step === 1 && (
        <Card className="w-full max-w-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              To personalize your experience, please tell us about your
              ...
              >
                <div className="flex items-center space-x-3 rounded-lg border border-[var(--color-trust-border)] p-4 transition-colors hover:bg-[var(--color-trust-surface)]/50">
                  ...
                  >
                    ...
                    <span className="text-gray-400 font-normal">
                      I have basic knowledge and want to learn more.
                    </span>
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-3 rounded-lg border border-[var(--color-trust-border)] p-4 transition-colors hover:bg-[var(--color-trust-surface)]/50">
                  ...
                  >
                    ...
                    <span className="text-gray-400 font-normal">
                      I actively protect myself but occasionally face doubts.
                    </span>
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-3 rounded-lg border border-[var(--color-trust-border)] p-4 transition-colors hover:bg-[var(--color-trust-surface)]/50">
                  ...
                  >
                    ...
                    <span className="text-gray-400 font-normal">
                      I am highly confident in identifying and handling threats.
                    </span>
                  </Label>
                </div>
              </RadioGroup>
          ...
          <form onSubmit={handleSurveySubmit}>
            <CardContent className="space-y-6 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
              {currentQuestions.map((q, index) => (
                <div
                  key={q.id}
                  className="space-y-3 pb-4 border-b border-[var(--color-trust-border)] last:border-0 last:pb-0"
                >
        ...
        <Card className="w-full max-w-md text-center py-8 px-4">
          <CardHeader>
            ...
            <CardDescription className="text-base mt-2">
              Thank you for completing the setup. TrustBox is now tailored to
              your expertise.
            </CardDescription>
          </CardHeader>
