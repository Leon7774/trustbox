  ...
  return (
    <div className="w-full flex flex-col items-center gap-12 animate-in fade-in duration-1000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mt-8 mb-24">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-slate-400 text-sm mb-8 flex-1 leading-relaxed">
              Evaluate your cybersecurity behavior based on proven psychological
              models (HBM & PMT) to reveal hidden vulnerabilities.
            </p>
        ...
        <Link
          href="/tools/password"
          className="group relative overflow-hidden rounded-2xl bg-trust-surface border border-trust-border backdrop-blur-xl shadow-2xl p-8 transition-all hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(20,184,166,0.15)] hover:border-trust-teal/50"
        >
          <div className="absolute -top-10 -right-10 p-4 opacity-[0.03] group-hover:opacity-10 transition-opacity duration-500">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-slate-400 text-sm mb-8 flex-1 leading-relaxed">
              Analyze password length, entropy, and complexity locally. Your
        ...
        <Link
          href="/tools/url"
          className="group relative overflow-hidden rounded-2xl bg-trust-surface border border-trust-border backdrop-blur-xl shadow-2xl p-8 transition-all hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(129,140,248,0.15)] hover:border-indigo-400/50"
        >
          <div className="absolute -top-10 -right-10 p-4 opacity-[0.03] group-hover:opacity-10 transition-opacity duration-500">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-slate-400 text-sm mb-8 flex-1 leading-relaxed">
              Scan links for structural anomalies and potential phishing
              indicators before you interact with them.
            </p>
