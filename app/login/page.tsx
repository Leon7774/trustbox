  ...
  return (
    <div className="w-full flex flex-col items-center justify-start p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center gap-3 mb-8">
        <ShieldCheck className="w-10 h-10 text-trust-teal" />
        <span className="text-3xl font-bold tracking-tight text-white">TrustBox</span>
      </div>
      ...
      <Card className="w-full max-w-[420px] relative z-10 border-trust-border/50 bg-trust-surface/80 backdrop-blur-2xl shadow-2xl p-2 sm:p-4">
        ...
        <form onSubmit={handleLogin}>
          ...
          <CardFooter className="flex flex-col space-y-5 pt-4">
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-trust-blue to-trust-teal hover:from-trust-blue/90 hover:to-trust-teal/90 text-white font-medium shadow-lg hover:shadow-trust-blue-glow/50 transition-all"
              disabled={loading}
              size="lg"
            >
              {loading ? (
